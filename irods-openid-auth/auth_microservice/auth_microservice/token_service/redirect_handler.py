    ...
    def accept(self, request):
        ...
        if not w:
            ...
            if w.return_to:
                ...
                #rgh: return to server and send the nonce so that the request can be matched to the originating request.
                ret = HttpResponseRedirect("https://irods1.it4i.cz/demo/irods?nonce="+nonce)
